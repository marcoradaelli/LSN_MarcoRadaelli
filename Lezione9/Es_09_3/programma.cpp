...
//		cout<<"CHIAMATO ORDINAMENTO DAL MAIN"<<endl;
		...
		cout<<"Terminata generazione "<<generazione<<", lunghezza media = "<<accu/(double)quanti_popolazione<<" ; lunghezza migliore = "<<arr_percorsi[0].calcola_lunghezza(arr_citta)<<endl;
	}
